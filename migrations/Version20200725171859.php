...
final class Version20200725171859 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, apartment_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, guests SMALLINT DEFAULT NULL, INDEX IDX_42C84955176DFE85 (apartment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
